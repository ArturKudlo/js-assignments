...
function encodeToRot13(str) {
    let engWords = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
    let codeWords = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
    let index = x => engWords.indexOf(x);
    let translate = x => index(x) > -1 ? codeWords[index(x)] : x;
